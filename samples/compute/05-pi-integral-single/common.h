...
static const cl_ulong kNumIters = 1024;
static const cl_ulong kNumSteps = 1024*1024;
static const cl_double kStepSize = 1.0 / (cl_double) kNumSteps;
static const cl_ulong kNumWorkItems = Compute::RoundupRange(
    kNumSteps / kNumIters, kWorkGroupSize);
