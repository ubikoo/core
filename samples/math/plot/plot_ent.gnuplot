...
set yrange [0:250.0]; set ytics 25; set mytics 5
...
set term wxt 0
set title "random32 rng"
show title
plot '/tmp/out.random32_plot' @hist ls 1 lw 0.1

set term wxt 1
set title "random64 rng"
show title
plot '/tmp/out.random64_plot' @hist ls 2 lw 0.1
